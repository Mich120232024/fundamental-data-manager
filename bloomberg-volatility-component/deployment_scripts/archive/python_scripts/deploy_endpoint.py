...
# Create a file with the endpoint code
with open('endpoint_to_add.py', 'w') as f:
    f.write(endpoint_code)

print("Endpoint code saved to endpoint_to_add.py")
print("Now deploying to VM...")

# Commands to execute
commands = [
    # 1. Backup
    "Copy-Item 'C:\\BloombergAPI\\main.py' 'C:\\BloombergAPI\\main_backup_deploy.py'",
    
    # 2. Add the code
    "Add-Content -Path 'C:\\BloombergAPI\\main.py' -Value (Get-Content 'C:\\BloombergAPI\\endpoint_to_add.py' -Raw)",
    
    # 3. Restart API
    "Get-Process python* | Stop-Process -Force",
    "Start-Sleep -Seconds 2", 
    "cd C:\\BloombergAPI; Start-Process C:\\Python311\\python.exe -ArgumentList 'main.py' -WindowStyle Hidden"
]
