...
import { ThemeToggle, DateSelector } from "@gzc/ui";
import { useTheme, useDateContext } from "@gzc/ui";
...
const Header = () => {
    ...
    return (
        <header className="col-span-2 flex items-center justify-between px-6 h-[60px] bg-gzc-white dark:bg-gzc-black border-b border-gzc-light-grey dark:border-gzc-dark-grey">
            <div className="text-lg font-semibold tracking-tight text-gzc-mid-black dark:text-gzc-light-grey">
                GZC Portfolio Aggregator
            </div>
